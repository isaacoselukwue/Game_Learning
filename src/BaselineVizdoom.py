...
if __name__ == "__main__":
    ...
    ##tweak the bc_visdoom_from_demonstration to use llm or a ml direction to generate a policy.
    ## try to compare the results with the one from sb-VizDoom.py
    ## try to see if you can make optuna work here to optimise the hyperparameters
    ## comparing hyperparameters with the dlrs algos
    ## also check workshop 6 to see steps eg starts from vizdoomfromdemonstration.py, supervisedpolicy.py, and then test with test human or random